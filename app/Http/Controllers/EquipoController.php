...
class EquipoController extends Controller
{
    ...
    function store(Request $request){
        ...
        Session::flash('succes', 'Se registró la persona con éxito.');
    ...
    public function update(Request $request, $id){
        ...
        Session::flash('succes', 'Se actualizó la persona con éxito.');
        return Redirect::to('admin/equipos');
    }
    ...
    function destroy($id){
        ...
        Session::flash('succes', 'Se eliminó la persona con éxito.');
        return Redirect::to('admin/equipos');
    }
}
