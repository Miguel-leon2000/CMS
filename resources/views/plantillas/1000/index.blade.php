      ...
      <section class="section section-xxl bg-default text-md-left">
       ...
       <section class="section section-xxl bg-default">
        <div class="container">
          ...
          <!-- Owl Carousel-->
          <div class="owl-carousel owl-style-9" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-margin="30" data-dots="true" data-mouse-drag="false">
        ...
        <div class="container">
          ...
          <div class="owl-carousel" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-dots="true" data-mouse-drag="false">
            ...
            @foreach ($blog as $item)
              <article class="post post-classic box-md wow slideInDown"><a class="post-classic-figure" href="blog-post.html"><img src="{{asset('blog/'.$item->imagen)}}" alt="" style="width:100% !important; height:200px !important"/></a>
          ...
          <div class="isotope-wrap">
            ...
            <div class="row row-30 isotope isotope-custom-1" data-lightgallery="group">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-2 isotope-item">
                <a href="{{$item->enlace}}" target="_blanck"><img src="{{asset('enlace/'.$item->imagen)}}" style="width:50% !important"></a>
              </div>
