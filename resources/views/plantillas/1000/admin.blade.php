...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('themes/1000/css/fonts.css')}}">
    <link rel="stylesheet" href="{{asset('themes/1000/css/style.css')}}">
  ...
  background-image: url({{asset('recursos_fondo/'.$general->fondo)}}) !important">  
    <div class="preloader">
            ...
            <div class="row row-40 row-md-50 justify-content-xl-between">
              <div class="col-md-10 col-lg-3 col-xl-4 wow fadeInRight">
                <div class="inset-xl-right-70">
                  <h5 class="footer-modern-title">Galeria</h5>
                  <div class="row row-10 gutters-10" data-lightgallery="group">

                    @foreach($galeria_footer as $item)
                      <div class="col-4 col-sm-2 col-lg-4">
                        <!-- Thumbnail Minimal--><a class="thumbnail-minimal" href="{{asset('galeria/'.$item->imagen)}}" data-lightgallery="item"><img src="{{asset('galeria/'.$item->imagen)}}" alt="" style="height:100px !important"/></a>
                      </div>
                    @endforeach
    ...
    <script src="{{asset('themes/1000/js/core.min.js')}}"></script>
    <script src="{{asset('themes/1000/js/script.js')}}"></script>
