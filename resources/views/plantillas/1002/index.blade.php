...
<section>
  ...
  <section class="section bg-catskill section-xl">
    <div class="container">
      ...
      <div class="row row-30 offset-top-60 text-left justify-content-sm-center">
        ...
        @foreach ($blog_index as $item)
          <div class="col-md-6 col-lg-4">
            <article class="post-news"><a href="http://127.0.0.1:8000/midominioweb/contenido/pagina/blog/{{$item->slug}}"><img class="img-responsive" src="{{asset('blog/'.$item->imagen)}}" style="width:380px !important; height:250px !important"></a>
      ...
      <div class="offset-top-50"><a class="btn button-primary" href="	http://127.0.0.1:8000/midominioweb/contenido/pagina/blog">Todas las entradas</a></div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row row-30 text-lg-left offset-top-60">
        ...
        <div class="col-md-6 col-lg-3">
            <img class="img-responsive d-inline-block img-rounded" src="{{asset('equipo/'.$item->imagen)}}" style="width:270px !important; height:270px !important">
          <div class="offset-top-20">
