...
@section('contenido')
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('index.pagina')}}">Mis páginas</a></li>
                <li class="breadcrumb-item active">Registro de página</li>
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <div class="row">
                                            @foreach ($plantillas as $item)
                                                <div class="col-lg-4">
                                                    <div class="card">
                                                    <input type="radio" id="customRadioInline1" name="idplantilla" class="form-control" value="{{$item->id}}" style="height:23px; margin-bottom:15px; margin-top:15px" >
