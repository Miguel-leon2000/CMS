...
@section('contenido')
<ol class="breadcrumb">
    <li class="breadcrumb-item active">Sección uno</li>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5>DATOS DE SECCIÓN UNO</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <input type="text" placeholder="Titulo de la sección uno" name="titulo"
                                                class="form-control" value="{{$seccion_uno->titulo}}">
                                        </div>
                                        <div class="col-lg-12 form-group">
                                            <textarea name="descripcion"
                                                id="editor">{{$seccion_uno->descripcion}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
