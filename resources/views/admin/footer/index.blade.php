...
@section('contenido')
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">Configuración footer</li>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="telefono" placeholder="Teléfono" value="{{$footer->telefono}}">
                                                </div>
                                                <div class="col-lg-12 form-group">
                                                    <input type="text" class="form-control" name="cr" placeholder="Texto del footer" value="{{$footer->cr}}">
                                                </div>
                                                <div class="col-lg-6 form-group">
                                                    <input type="email" class="form-control" name="correo" placeholder="Correo electrónico" value="{{$footer->correo}}">
                                                </div>
                                                <div class="col-lg-6 form-group">
