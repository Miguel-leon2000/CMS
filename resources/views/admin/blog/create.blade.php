...
<div class="container-fluid">
    <div id="ui-view">
        <div>
            ...
            <form method="POST" action="{{route('store.blog')}}" role="form"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div>
                                            ...
                                            <textarea name="excerpt" class="form-control" placeholder="Descripción corta" style="margin-top:30px; height:80px !important"></textarea>
