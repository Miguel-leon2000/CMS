...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Edición de slider</li>
        ...
        <div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form method="POST" action="{{route('update.slider',$slider->id)}}" role="form"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input name="_method" type="hidden" value="PATCH">
                            <div class="card">
                                <div class="card-header">
                                    <h5>EDICIÓN DE SLIDER</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <input type="text"
                                                ...
                                                name="titulo" value="{{$slider->titulo}}">
